...
| listScrollbarView            | boolean                                                                                                                                                                                         | Whether the scrollbar is exposed in the flatList               | size.maxHeight lets you set the maximum height value for the FlatList, which allows you to decide whether to expose the scrollbar when scrolling occurs                                                                                                                                                                        | False                            |
